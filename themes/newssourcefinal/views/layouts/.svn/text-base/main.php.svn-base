		...
		<div class="menu">
				<?php $this->widget('zii.widgets.CMenu',array(
					'items'=>array(
						...
						array('label'=>'Tomer', 'url'=>array('user/tomer')),
						array('label'=>'Message', 'url'=>array('user/message')),
...
<a href="#" class="button"> Read More </a>
	...
	*/ ?>
		...
		<aside id="sidebar2"><!-- sidebar2 -->
				<h3>Events</h3>
					<ul>
						<li><a href="#">Office Depot Visit</a></li>
						<li><a href="#">Ultimate Software Visit</a></li>
						<li><a href="#">Affordable SEOs Recruiting</a></li>
					</ul>
				<br>
<br>
