...
require_once Yii::app()->basePath.'/fiu/service/Google_Model.php';
require_once Yii::app()->basePath.'/fiu/service/Google_Service.php';
require_once Yii::app()->basePath.'/fiu/service/Google_ServiceResource.php';
require_once Yii::app()->basePath.'/fiu/auth/Google_AssertionCredentials.php';
require_once Yii::app()->basePath.'/fiu/auth/Google_Signer.php';
require_once Yii::app()->basePath.'/fiu/auth/Google_P12Signer.php';
require_once Yii::app()->basePath.'/fiu/service/Google_BatchRequest.php';
require_once Yii::app()->basePath.'/fiu/external/URITemplateParser.php';
require_once Yii::app()->basePath.'/fiu/auth/Google_Auth.php';
require_once Yii::app()->basePath.'/fiu/cache/Google_Cache.php';
require_once Yii::app()->basePath.'/fiu/io/Google_IO.php';
require_once(Yii::app()->basePath.'/fiu/service/Google_MediaFileUpload.php');
