...
class ReminderCommand extends CConsoleCommand
{
    ...
    {   
    	...
    	$entries = VideoInterview::model()->findAllBySql("SELECT * FROM video_interview WHERE date=:date AND time BETWEEN CONVERT("  ."'"   .$time.  "'" .  ", TIME) AND CONVERT("  ."'"  .$futuretime.  "'" .    ", TIME)", array(":date"=>$date));
