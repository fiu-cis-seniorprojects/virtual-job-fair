...
require_once Yii::app()->basePath."/google/config.php";
...
require_once Yii::app()->basePath.'/google/service/Google_Model.php';
require_once Yii::app()->basePath.'/google/service/Google_Service.php';
require_once Yii::app()->basePath.'/google/service/Google_ServiceResource.php';
require_once Yii::app()->basePath.'/google/auth/Google_AssertionCredentials.php';
require_once Yii::app()->basePath.'/google/auth/Google_Signer.php';
require_once Yii::app()->basePath.'/google/auth/Google_P12Signer.php';
require_once Yii::app()->basePath.'/google/service/Google_BatchRequest.php';
require_once Yii::app()->basePath.'/google/external/URITemplateParser.php';
require_once Yii::app()->basePath.'/google/auth/Google_Auth.php';
require_once Yii::app()->basePath.'/google/cache/Google_Cache.php';
require_once Yii::app()->basePath.'/google/io/Google_IO.php';
require_once(Yii::app()->basePath.'/google/service/Google_MediaFileUpload.php');
